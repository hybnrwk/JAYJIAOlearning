...
这是这个私人学习仓库的低维护 Wiki 入口。它不替代原始课程目录，只提供一层更稳定的导航：从学科地图、课程索引、资源清单和高频概念进入已有笔记。
...
- [[cs_ds/cs_introduction/00-cs_introduction索引|CS 入门与衔接]]
- [[cs_ds/cs_self_learning/00-cs_self_learning索引|CS 自学资料库]]
...
- 2026-08-09 后新增的机器学习路线、PyTorch、数值代数与随机过程资料从对应课程索引进入。
